      ...
      <SidebarContent className="bg-card border-r border-border">
        <div className="p-4 border-b border-border h-20">
          {isCollapsed ? <div className="flex h-full items-center justify-center">
              ...
              <img src="Sumori.png" alt="Sumori Logo" className="h-12 w-auto"/>
            ...
            <SidebarMenu>
              {navigationItems.map(item => <SidebarMenuItem key={item.title}>
                  ...
                  isActive
                      ...
                      <item.icon className={isCollapsed ? "h-6 w-6" : "mr-3 h-6 w-6"} />
        ...
        <div className="mt-auto p-4 border-t border-border">
            <SidebarMenuButton className={`w-full text-danger hover:bg-danger/10 ${isCollapsed ? 'flex justify-center' : ''}`} onClick={logout}>
            <LogOut className={isCollapsed ? "h-6 w-6" : "mr-3 h-6 w-6"} />
